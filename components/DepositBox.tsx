      ...
      <View className="relative p-4 w-full">
        ...
        {filteredDeposits.map((deposit: any, index: number) => (
          <View
            ...
            {/* buttons */}
            <View className="relative left-12 flex-row px-2 mt-6">
              {/* update */}
              <TouchableOpacity
                className={`w-28  flex-row items-center justify-end rounded-xl transform active:scale-95 transition-all`}
                onPress={() =>
                  router.push({
